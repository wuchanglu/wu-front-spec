...
describe("Validate TS configs", () => {
  it("测试 eslint对ts的检测，文件路径为/typescript", async () => {
  ...
  it("测试 eslint对ts的检测，文件路径为/typescript/vue", async () => {
  ...
  it("测试 eslint对ts的检测，文件路径为/essential/typescript", async () => {
    const configPath = path.resolve(
      __dirname,
      "../essential/typescript/index.js"
    );
    const filePath = path.join(__dirname, "./fixtures/ts.ts");
  ...
  it("测试 eslint对ts的检测，文件路径为/essential/typescript/react", async () => {
    const configPath = path.resolve(
      __dirname,
      "../essential/typescript/react.js"
    );
  ...
  it("测试 eslint对ts的检测，文件路径为/essential/typescript/vue", async () => {
    const configPath = path.resolve(
      __dirname,
      "../essential/typescript/vue.js"
    );
    const filePath = path.join(__dirname, "./fixtures/ts-vue.vue");
  ...
  it("测试 eslint对ts的检测，文件路径为/typescript/node", async () => {
    const configPath = path.resolve(__dirname, "../typescript/node.js");
